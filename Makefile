...
ifeq ($(ROOTLESS),1)
	...
	Comet_XCODEFLAGS = SWIFT_ACTIVE_COMPILATION_CONDITIONS="ROOTHIDE"
	THEOS_PACKAGE_SCHEME = roothide
	COMET_INSTALL_PATH = /Library/Frameworks
	COMET_LINK_PREFIX = @loader_path/.jbroot
...
Comet_XCODEFLAGS += LD_DYLIB_INSTALL_NAME=$(COMET_LINK_PREFIX)$(COMET_INSTALL_PATH)/Comet.framework/Comet
Comet_XCODEFLAGS += DYLIB_INSTALL_NAME_BASE=$(COMET_LINK_PREFIX)$(COMET_INSTALL_PATH)/Comet.framework/Comet
